...
public interface JeepSaleController {
	// @formatter:off
	@Operation(
			...
			responses = {
				...
				@ApiResponse(responseCode = "404", description = "No Jeeps were foudn with the input criteria", content = @Content(mediaType = "application/json")),
